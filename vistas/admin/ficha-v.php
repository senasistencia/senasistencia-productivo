...
if (isset($_REQUEST['ac']))
{
  ...
  switch ($_REQUEST['ac']) {
    case 'registrar':
      ...
      $programa->__GET('grupo'), $ficha->__GET('jornada'),$ficha->__GET('trimestre'),
   ...
   case 'actualizar':
      ...
      Jornada_Ficha = ? , Trimestre_Ficha = ?, Trimestre_Ficha = ? WHERE ID_Ficha = ?";
      $objeto = $PDO->prepare($consulta);
      $objeto->execute(array( $ficha->__GET('id_ficha'),$ficha->__GET('FK_programa'),$ficha->__GET('num_ficha'),
      $ficha->__GET('grupo'),$ficha->__GET('jornada'),$ficha->__GET('estado')));
          ...
          <div class="container">
            <div class="row">
                ...
                <div class="section">
                  ...
                  <input type="text" name="num_ficha" placeholder="Fichas" value="<?php echo $ficha->__GET('num_ficha');?>" />
                  <input type="text" name="FK_programa" placeholder="Programa" value="<?php echo $ficha->__GET('FK_programa');?>" />
